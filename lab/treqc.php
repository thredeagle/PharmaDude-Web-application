...
$s="SELECT * FROM testbooking,category,labtest where testbooking.testid=labtest.testid and category.categoryid=labtest.categoryid and labtest.labid='$j' and testbooking.status=3";
