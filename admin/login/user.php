...
<head>
    ...
    <title>User Registration - PharmaDude</title>
...
<body style="background-image: url(images/bck.png);" >
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>Registration</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                ...
                <li><a href="scollector.php">Sample Collector Registration</a></li>
...
<br> 
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form action="../php/php_ureg.php" id="signup-form" name="signup" class="signup-form" onsubmit="return validate()"  method="POST" enctype="multipart/form-data">
                        <h2 class="form-title" style="text-transform: none;color:white;"><img src="images/user2.png" height="60" width="60" >&nbsp;&nbsp;User Registration</h2><br>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group" required>
                                        <input type="date" class="form-input" name="dob" onfocus="(this.type='date')" onblur="(this.type='text')"  id="dob" placeholder="DOB" style="line-height: inherit;" >
                                        <span id="erdob"></span>
                                    </div>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                      <select class="form-input" name="district"  required>
                                                          <option disabled="disabled" value="null" selected="selected">District</option>
                                                         <?php
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-input" name="pincode" id="pincode" placeholder="Pincode"  >
                                        <span id="erpin"></span>
                                    </div>
                                    

                                    <div class="form-group">
                                        <input type="number" class="form-input" name="phone" id="phone" placeholder="Contact Number" maxlength="10"  >
                                        <span id="erph"></span>
                                    </div>
                                    
                                    <div class="form-group">
                                    <input type="file" name="profilepic" class="form-control" id="img">
                                    </div>
    ...
    <script type="text/javascript" src="js/regvalidateuser.js"></script>
