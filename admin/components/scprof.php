...
require('../header.php');
$sql="select * from login,cuser, district where login.username=cuser.email and status=0 and district.distid=cuser.distid";
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" style="font-size:x-small;" data-bs-toggle="tab" data-bs-target="#profile-change-password">Change Password</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                      <input name="gender" type="text" class="form-control" id="gender" placeholder="Male/Female/Others">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" placeholder="@gmail.com" >
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="Phone" type="Phone" class="form-control" id="Phone" placeholder="must contain 10 digits">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                   ...
                   <form action="passed.php" method="POST" name="pass" onsubmit="return validate()">
