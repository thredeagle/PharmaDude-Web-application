...
require('header.php');
$sql="SELECT * FROM scollector,district WHERE email IN (SELECT username FROM login WHERE(status=1 AND utype='s')) and scollector.distid=district.distid";
...
<main id="main" class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Suspend Sample Collector </h5>
