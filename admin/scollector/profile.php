        ...
        <!-- <div class="col-xl-4"> -->
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h2 style="color:white"><?php echo $f['name']; ?></h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="php/update.php" method="POST">
                    <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label" style="color:white">Profile Image</label>
                      <div class="col-md-8 col-lg-9" >
                      <img src="<?php echo '../uploads/lab/'.$f['profilepic'];?>" alt="Profile">
                        <div class="pt-2">
