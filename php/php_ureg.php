...
$c="SELECT * FROM cuser WHERE email='$email'";
     ...
     {
          $sql="insert into cuser (name, address,dob,gender,city,distid,pincode,email,phone,profilepic) VALUES ('$name','$address','$dob','$gender','$city','$district','$pincode','$email','$phone','$pic')";
         
            if(mysqli_query($conn,$sql))   
            {


                $sql1="insert into login(username,password,utype) VALUES ('$email','$pass','u') ";
