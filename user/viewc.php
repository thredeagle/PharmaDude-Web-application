...
require "header.php";
$sql="select * from complaint,cuser where complaint.userid=cuser.email ";
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                while($row=mysqli_fetch_assoc($a))
                {
                  ...
                  <td><?php
                  if($row['status']==-1){ ?><font color="red"><?php echo "pending";}?></font><?php
                 if($row['status']==1){?><font color="blue"><?php echo "Resolved";}?></font></td>
