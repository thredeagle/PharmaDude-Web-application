<?php
  ...
  $m=$_SESSION['email'];
  $s="select testrate FROM  labtest,testbooking where testbooking.emailid='$m'";
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                      <input type="number" disabled="" name="amt" value="<?php echo $a['testrate'] ; ?>" class="form-control">
                    </div>
                  </div>
                 
                 
                  <div class="col-sm-10">
                    <button type="button" onclick="pay(<?php  echo $a['testrate'];?>)" class="btn btn-primary ">Pay</button>
                  </div>
                </form>
...
<script>
	...
	function pay(amt){
		...
		"callback_url": "successs.php?amt="+amt,
		"prefill": {
