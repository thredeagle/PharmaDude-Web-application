...
<head>
    ...
    <title>Corporate Registration - PharmaDude </title>
...
<br>
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form method="POST" action="../php/php_lreg.php" id="signup-form" class="signup-form" onsubmit="return validate()" enctype="multipart/form-data">
                        <h2 class="form-title" style="text-transform:none;"><img src="images/micro.png" width="60" height="60">&nbsp;<font color="white">Corporate Registration</font></h2><br>
                        <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="license" id="license" placeholder="License Number" required/>
  ...
  <font color="white">Have already an account?</font><a href="signin/login.php" style="text-decoration:none;color:white;">&nbsp;Login Here</a>
    ...
    <script type="text/javascript" src="js/regvalidatelab.js"></script>
</body>
</html>
